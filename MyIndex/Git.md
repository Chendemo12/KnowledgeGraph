...
**git 命令** 很多人都知道，Linus 在 1991 年创建了开源的 Linux，从此，Linux 系统不断发展，已经成为最大的服务器系统软件了。
...
[Git 常用命令清单](https://github.com/jaywcjlove/handbook/blob/master/other/Git常用命令清单.md)
...
`git clone [user@]example.com:path/to/repo.git/` #SSH 协议还有另一种写法。
...
```
vim ~/.ssh/config` #修改 config 文件，如果没有创建 `config
...
只能拉取 `origin` 里的一个 url 地址，这个 fetch-url
...
只需要更改 config 文件里，那三个 url 的顺序即可，fetch-url 会直接对应排行第一的那个 utl 连接。
...
这个功能在 Github 上可以玩儿，Gitlab 上特别老的版本不能玩儿哦，那么如何跟随着 commit 关闭一个 issue 呢？在 confirm merge 的时候可以使用一下命令来关闭相关 issue:
...
[Github 官方教程](https://help.github.com/articles/changing-author-info/)
...
+  [Git 官网](https://wangchujiang.com/linux-command/)
+  [**Github 15 分钟学习 Git**](https://wangchujiang.com/linux-command/)
...
[添加命令](https://github.com/jaywcjlove/linux-command/new/master/command) | [命令列表](https://wangchujiang.com/linux-command/hot.html) | [Chrome 插件](https://github.com/jaywcjlove/oscnews) | [Alfred](https://github.com/jaywcjlove/linux-command/releases) | [Krunner](https://github.com/roachsinai/krunner-linuxcommands) | [开源中国 Web 版](http://jaywcjlove.gitee.io/linux-command/) 
[Github](https://github.com/jaywcjlove/linux-command) | [短地址：https://git.io/linux](https://jaywcjlove.github.io/linux-command/) 
